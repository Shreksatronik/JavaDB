...
public class Main {
    ...
    public static void main(String[] args) throws IOException, XMLStreamException {
        ...
        String filename2 = "output.xml";

        XMLOutputFactory factory = XMLOutputFactory.newInstance();
        XMLEventWriter writer = factory.createXMLEventWriter(new FileWriter(filename2));
        ...
        ListIterator<Person> lItr = persons.listIterator();
        XMLEventFactory  eventFactory = XMLEventFactory.newInstance();
        while (lItr.hasNext())
        {
            XMLEvent event = eventFactory.createCData(String.valueOf(lItr.next()));
            writer.add(event);
        }

    }

    private static List<Person> combinePeople(List<Person> persons) throws XMLStreamException, IOException {
    ...
    private static List<Person> parseXMLfile(String fileName) throws IOException, XMLStreamException {
