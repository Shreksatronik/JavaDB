...
public class Person {
    ...
    public Person(String id) throws FileNotFoundException {
        this.id = id;
    }
    ...
    public void addSibling(String id) throws FileNotFoundException {
        addSibling(new Person(id));
    }

    public void addSibling(String name, String gender) throws FileNotFoundException {
    ...
    public void addChild(String name) throws FileNotFoundException {
        Person child = new Person();
        child.setFullName(name);
        addChild(child);
    }

    public void addChild(String id, String gender) throws FileNotFoundException {
    ...
    public void addParent(String id) throws FileNotFoundException {
        Person parent = new Person(id);
        addParent(parent);
    }

    public void addParent(String fullname, String gender) throws FileNotFoundException {
    ...
    public void setSpouse(String name) throws FileNotFoundException {
    ...
    public void setWife(String id) throws FileNotFoundException {
    ...
    public void setHusband(String id) throws FileNotFoundException {
        if (this.spouse != null && !Objects.equals(id, this.spouse.getId())) {
